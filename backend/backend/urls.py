...
router.register('trees', b2.TreeView, basename = 'tree')
router.register(r'gardens', b2.GardenView, 'Garden')
router.register(r'vehicles', b2.VehicleView, 'Vehicle')
...
urlpatterns = [
    ...
    path('api/ecolearning/food', b2.food, name = "vehicles"),
